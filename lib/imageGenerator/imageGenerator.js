...
const CALIBRI_FONT = path.join(__dirname, '..', '..', 'public', 'assets', 'fonts', 'calibri-regular.ttf');
const ARIAL_FONT = path.join(__dirname, '..', '..', 'public', 'assets', 'fonts', 'ArialTh.ttf');
const USERNAME = '@ContadorQueda';

GlobalFonts.registerFromPath(CALIBRI_FONT, 'Calibri');
GlobalFonts.registerFromPath(ARIAL_FONT, 'Arial');

console.info('Fonts registered to be used: ', GlobalFonts.families);
